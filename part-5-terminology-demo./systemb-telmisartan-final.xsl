    ...
    <xsl:template match="/ccda:ClinicalDocument">
        <Message DatatypesVersion="20170715" TransportVersion="20170715" TransactionDomain="SCRIPT"
            ...
            <Header>
                ...
                <SentTime>2024-01-01T10:00:23</SentTime>
                <SenderSoftware>
            ...
            <Body>
                <NewRx>
                    ...
                    <MedicationPrescribed>
                        <DrugDescription>
                            <xsl:value-of
                                select="ccda:component/ccda:structuredBody/ccda:component/ccda:section/ccda:entry/ccda:substanceAdministration/ccda:consumable/ccda:manufacturedProduct/ccda:manufacturedMaterial/ccda:code/@displayName"/>
                        </DrugDescription>
                        <DrugCoded>
                            <ProductCode>
                                <Code>
                                    <xsl:value-of
                                        select="ccda:component/ccda:structuredBody/ccda:component/ccda:section/ccda:entry/ccda:substanceAdministration/ccda:consumable/ccda:manufacturedProduct/ccda:manufacturedMaterial/ccda:code/@code"/>
                                </Code>
                            ...
                            <Strength>
                                ...
                                <StrengthForm>
                                    <Code><xsl:value-of
                                        select="ccda:component/ccda:structuredBody/ccda:component/ccda:section/ccda:entry/ccda:substanceAdministration/ccda:routeCode/@code"/></Code></StrengthForm>
                            ...
                            <DrugDBCode>
                                <Code>
                                    <xsl:value-of
                                        select="ccda:component/ccda:structuredBody/ccda:component/ccda:section/ccda:entry/ccda:substanceAdministration/ccda:consumable/ccda:manufacturedProduct/ccda:manufacturedMaterial/ccda:code/@codeSystem"/>
                                </Code>
                        ...
                        <Sig>
                            ...
                            <CodeSystem>
                                <SNOMEDVersion>2024-01-01</SNOMEDVersion>
